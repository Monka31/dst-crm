            ...
            {items.sort((a, b) => (a.start_time ?? "").localeCompare(b.start_time ?? "")).map((r) => (
              <div key={r.id} className="flex flex-wrap items-center justify-between gap-3 px-4 py-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Badge className={r.confirmation === "confirmee" ? "bg-green-100 text-green-800 dark:bg-green-950 dark:text-green-300"
                    : r.confirmation === "annulee" ? "bg-red-100 text-red-700 dark:bg-red-950 dark:text-red-300" : "bg-amber-100 text-amber-800 dark:bg-amber-950 dark:text-amber-300"}>
