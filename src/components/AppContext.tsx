...
type Ctx = {
  ...
  members: Profile[];
  /**
   * Les comptes qui peuvent écrire, hors lecteurs.
   *
   * C'est la seule liste à proposer dans un sélecteur de personne : on
   * n'attribue pas une entreprise, une tâche ou une relance à quelqu'un qui
...
export function AppProvider({ children }: { children: React.ReactNode }) {
  ...
  const value: Ctx = {
    session, profile, poles, members, editeurs, settings, loading,
    isAdmin: role === "admin",
